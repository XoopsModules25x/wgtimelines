...
class Items extends \XoopsObject
{
    ...
    public function getFormItems($action = false, $ui = 'admin')
    {
        ...
        $radioIcon = new \XoopsFormRadio('', 'item_icon', $item_icon);
        $radioIcon->addOption('none', "<i class='glyphicon'> ". _AM_WGTIMELINES_ITEM_NONE . '</i>');
        $this->addGlyphicons($radioIcon);
        $toggleIcon .= $radioIcon->render();
