...
\define('_CO_WGTIMELINES_TIMELINE_EXPIRED', 'Abgelaufene Einträge');
...
\define('_CO_TIMELINE_EXPIRED_SHOW', 'Weiterhin anzeigen');
\define('_CO_TIMELINE_EXPIRED_HIDE', 'Nicht mehr anzeigen');
