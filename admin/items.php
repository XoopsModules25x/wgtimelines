...
switch($op) {
    ...
    default:
        ...
        if ( $timelinesCount > 0 ) {
            ...
            $form_select = new XoopsThemeForm( _AM_WGTIMELINES_TIMELINE_SELECT, "form_filter", $action, "post", true);
            $form_select->setExtra('enctype="multipart/form-data"');
            $timeline_select = new XoopsFormSelect(_AM_WGTIMELINES_TIMELINE_NAME, "tl_id", $tl_id);
